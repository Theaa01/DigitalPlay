...
<div class="bg-gray-800 rounded-lg shadow-lg overflow-hidden">
    ...
    <div class="p-4">
        ...
        <div class="flex items-center justify-between">
            ...
            <!-- Botón Comprar -->
            <div>
                <button data-id="{{ $game->id }}" class="add-to-cart-btn px-6 py-2 rounded-full text-orange-500 border border-orange-500 transition bg-transparent hover:bg-orange-500 hover:text-white">
                    Comprar
                </button>
            </div>
        </div>
